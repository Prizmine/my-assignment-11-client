...
const Leaderboard = () => {
  ...
  return (
    <section className="py-12 bg-base-100 min-h-screen mb-[100px] rounded-3xl">
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-12">
          {topThree.map((user, index) => (
            <div
              key={user._id}
              className="bg-base-100 border rounded-xl shadow-sm p-6 text-center"
            >
        ...
        <div className="bg-base-100 border rounded-xl shadow-sm overflow-x-auto">
